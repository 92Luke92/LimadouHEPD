	 ...
	 <table border="1">
	   <tr bgcolor="#1acd32">
		 ...
		 <tr>
		   <table border="1">
		     <tr bgcolor="#1acd32">
		       <td width="90" height="100" align="center"> Current SD Ladders Mask </td>
		       <tr>
		       <td width="30" height="50" align="center"> Top </td>
		       <td width="30" height="50" align="center"> Central </td>
		       <td width="30" height="50" align="center"> Bottom </td>
		       </tr>
	   ...
	   <xsl:for-each select="//SILCONFIG">
		 ...
		 <table border="1">
		   <tr>
			 ...
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="CURRENT_SD_top"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="CURRENT_SD_top"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>

		     <xsl:choose>
		       <xsl:when test="LADDER_MASK_error_central &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="CURRENT_SD_central"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="CURRENT_SD_central"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>

		    <xsl:choose>
		       <xsl:when test="LADDER_MASK_error_bottom &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="CURRENT_SD_bottom"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="CURRENT_SD_bottoml"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>

		      <xsl:choose>
		       <xsl:when test="LADDER_error_top &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="LADDERS_LV_top"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="LADDERS_LV_top"/>        </td>
		       </xsl:otherwise>
		      </xsl:choose>

		       <xsl:choose>
		       <xsl:when test="LADDER_error_central &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="LADDERS_LV_central"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="LADDERS_LV_central"/>        </td>
		       </xsl:otherwise>
		       </xsl:choose>

		       <xsl:choose>
		       <xsl:when test="LADDER_error_bottom &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="LADDERS_LV_bottom"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="LADDERS_LV_bottom"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>
		  ...
		  <table border="1">
		    <tr>
			 ...
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="ADIACENT_STRIP"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="ADIACENT_STRIP"/>        </td>
		       </xsl:otherwise>
		      </xsl:choose>

		      <xsl:choose>
		       <xsl:when test="ZERO_SUPP_error &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="ZERO_SUPP_THRD"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="ZERO_SUPP_THRD"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>
		      
		     <xsl:choose>
		       <xsl:when test="CN_HIGH_error &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="THRD_CN_HIGH"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="THRD_CN_HIGH"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>

		      <xsl:choose>
		       <xsl:when test="CN_LOW_error &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="THRD_CN_LOW"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="THRD_CN_LOW"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>
		      
		        <xsl:choose>
		       <xsl:when test="EVENT_RMS_error &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="CALIB_EVENT_RMS"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="CALIB_EVENT_RMS"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>

		      <xsl:choose>
		       <xsl:when test="EVENT_PED_error &gt;'0'">
			 <td  bgcolor="#ff0000" width="100" height="30" align="center"> <xsl:value-of select="CALIB_EVENT_PED"/> </td>
		       </xsl:when>
		       <xsl:otherwise>
			 <td width="100" height="30" align="center"><xsl:value-of select="CALIB_EVENT_PED"/>        </td>
		       </xsl:otherwise>
		     </xsl:choose>
