...
// ********************************************************************
//
/// \file electromagnetic/TestEm3/include/CalorimeterConstructionOptical.hh
/// \brief Definition of the CalorimeterConstructionOptical class
//
// $Id$
//
...
#ifndef CalorimeterConstructionOptical_h
#define CalorimeterConstructionOptical_h 1
...
class CalorimeterConstructionOptical 
{
public:
  
  CalorimeterConstructionOptical();
  ~CalorimeterConstructionOptical();
...
private:
  ...
  G4double fPmtS1_OuterRadius;  //OP
  G4double fPmtSCal_OuterRadius;  //OP
  ...
  G4Tubs* fSolidS1Pmt;  //OP
  G4Tubs* fSolidSCalPmt;  //OP
  ...
  G4LogicalVolume* fLogicS1Pmt;  //OP
  G4LogicalVolume* fLogicSCalPmt;  //OP
  ...
  G4LogicalVolume* fLogicScintLayer_Odd;
  G4LogicalVolume* fLogicScintLayer_Even;
  G4LogicalVolume* fLogicScintActiveLayer_Odd;
  G4LogicalVolume* fLogicScintActiveLayer_Even;
  ...
  //OP - begin
  G4VPhysicalVolume* fPhysiT1Pmt1;
  G4VPhysicalVolume* fPhysiT1Pmt2;
  G4VPhysicalVolume* fPhysiT2Pmt1;
  G4VPhysicalVolume* fPhysiT2Pmt2;
  G4VPhysicalVolume* fPhysiT3Pmt1;
  G4VPhysicalVolume* fPhysiT3Pmt2;
  G4VPhysicalVolume* fPhysiT4Pmt1;
  G4VPhysicalVolume* fPhysiT4Pmt2;
  G4VPhysicalVolume* fPhysiT5Pmt1;
  G4VPhysicalVolume* fPhysiT5Pmt2;
  G4VPhysicalVolume* fPhysiT6Pmt1;
  G4VPhysicalVolume* fPhysiT6Pmt2;

  G4VPhysicalVolume* fPhysiP1Pmt1;
  G4VPhysicalVolume* fPhysiP1Pmt2;
  G4VPhysicalVolume* fPhysiP2Pmt1;   
  G4VPhysicalVolume* fPhysiP2Pmt2;   
  G4VPhysicalVolume* fPhysiP3Pmt1;   
  G4VPhysicalVolume* fPhysiP3Pmt2;   
  G4VPhysicalVolume* fPhysiP4Pmt1;   
  G4VPhysicalVolume* fPhysiP4Pmt2;   
  G4VPhysicalVolume* fPhysiP5Pmt1;   
  G4VPhysicalVolume* fPhysiP5Pmt2;   
  G4VPhysicalVolume* fPhysiP6Pmt1;   
  G4VPhysicalVolume* fPhysiP6Pmt2;   
  G4VPhysicalVolume* fPhysiP7Pmt1;   
  G4VPhysicalVolume* fPhysiP7Pmt2;   
  G4VPhysicalVolume* fPhysiP8Pmt1;   
  G4VPhysicalVolume* fPhysiP8Pmt2;   
  G4VPhysicalVolume* fPhysiP9Pmt1;   
  G4VPhysicalVolume* fPhysiP9Pmt2;   
  G4VPhysicalVolume* fPhysiP10Pmt1;   
  G4VPhysicalVolume* fPhysiP10Pmt2;   
  G4VPhysicalVolume* fPhysiP11Pmt1;   
  G4VPhysicalVolume* fPhysiP11Pmt2;   
  G4VPhysicalVolume* fPhysiP12Pmt1;   
  G4VPhysicalVolume* fPhysiP12Pmt2;   
  G4VPhysicalVolume* fPhysiP13Pmt1;   
  G4VPhysicalVolume* fPhysiP13Pmt2;   
  G4VPhysicalVolume* fPhysiP14Pmt1;   
  G4VPhysicalVolume* fPhysiP14Pmt2;   
  G4VPhysicalVolume* fPhysiP15Pmt1;   
  G4VPhysicalVolume* fPhysiP15Pmt2;   
  G4VPhysicalVolume* fPhysiP16Pmt1;   
  G4VPhysicalVolume* fPhysiP16Pmt2;   

  G4VPhysicalVolume* fPhysiL1Pmt;   
  G4VPhysicalVolume* fPhysiL2Pmt;   
  G4VPhysicalVolume* fPhysiL3Pmt;   
  G4VPhysicalVolume* fPhysiL4Pmt;   
  G4VPhysicalVolume* fPhysiL5Pmt;   
  G4VPhysicalVolume* fPhysiL6Pmt;   
  G4VPhysicalVolume* fPhysiL7Pmt;   
  G4VPhysicalVolume* fPhysiL8Pmt;   
  G4VPhysicalVolume* fPhysiL9Pmt;
  //OP - end

  G4VPhysicalVolume* fPhysiCaloBox;
  G4VPhysicalVolume* fPhysiScintBox;
  G4VPhysicalVolume* fPhysiScintLayer_Odd;
  G4VPhysicalVolume* fPhysiScintLayer_Even;
  G4VPhysicalVolume* fPhysiScintCFSupp;
  G4VPhysicalVolume* fPhysiScintActiveLayer_Odd;
  G4VPhysicalVolume* fPhysiScintActiveLayer_Even;
