...
prescaledmev2adcmethod::prescaledmev2adcmethod(std::string datacardname)
   : calomev2adcmethod(datacardname)
{
	init();
}

void prescaledmev2adcmethod::init() {
  convertDatacard();
  addMevPeak();
  computeMev2ADCratio();
}
...
void prescaledmev2adcmethod::convertDatacard() {
  int iPMT=0;
...
void prescaledmev2adcmethod::addMevPeak()
{
...
void prescaledmev2adcmethod::computeMev2ADCratio() {
